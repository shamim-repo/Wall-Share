package com.msbshamim60.wallshare.bottom_nav_ui.all.newTab;
...
public class NewTabFragment extends Fragment implements OnClickHandler {
    ...
    private void setupFirestore() {
        ...
        Query query=postReference.orderBy("time",Query.Direction.DESCENDING);
